...
| [`test-vectors/platform-parity/`](./test-vectors/platform-parity/) | Frozen cross-implementation byte-equality fixture copied from the TrueTake platform repo (§10.9). |
